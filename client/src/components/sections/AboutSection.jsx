...
export const AboutSection = () => {
  return (
    <section id="about" className="py-16 sm:py-24 relative bg-bg-secondary/50 border-y border-border-glass">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-7 glass-card p-5 xs:p-6 sm:p-8 lg:p-10 flex flex-col justify-between"
          >
            <div>
              <div className="flex items-center gap-3 mb-5 sm:mb-6">
                <div className="p-2.5 sm:p-3 rounded-xl bg-accent-1/10 text-accent-1 border border-accent-1/20 shrink-0">
                  <Code className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <h3 className="text-lg xs:text-xl sm:text-2xl font-bold font-display text-text-primary">
              ...
              <div className="mb-6 sm:mb-8">
                <a
                  ...
                  className="w-full xs:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-3 rounded-xl bg-gradient-to-r from-accent-1 to-accent-2 text-white font-medium text-sm shadow-glow-indigo hover:shadow-glow-cyan hover:scale-[1.02] active:scale-[0.98] transition-all touch-target"
                >
            ...
            {/* Stats Grid */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-4 pt-5 sm:pt-6 border-t border-border-glass">
              {PERSONAL_INFO.stats.map((stat, idx) => (
                <div key={idx} className="text-center p-2.5 sm:p-3 rounded-xl bg-bg-primary/40 border border-border-glass">
                  <span className="block text-xl sm:text-3xl font-extrabold font-display gradient-text">
                    {stat.value}{stat.suffix}
                  </span>
                  <span className="text-[10px] sm:text-[11px] text-text-muted font-medium tracking-tight">
                    {stat.label}
                  </span>
                </div>
              ))}
          ...
          >
            {/* Education Box */}
            <div className="glass-card p-5 xs:p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-5 sm:mb-6">
                <div className="p-2.5 sm:p-3 rounded-xl bg-accent-2/10 text-accent-2 border border-accent-2/20 shrink-0">
              ...
              {PERSONAL_INFO.education.map((edu, idx) => (
                <div key={idx} className="p-3.5 sm:p-4 rounded-xl bg-bg-secondary/80 border border-border-glass space-y-1.5 sm:space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] sm:text-xs font-mono font-semibold px-2.5 py-0.5 rounded-full bg-accent-1/10 text-accent-1 border border-accent-1/30">
                      {edu.period}
                    </span>
                  </div>
                  <h4 className="text-sm sm:text-base font-bold font-display text-text-primary">
                    {edu.degree}
                  </h4>
            ...
            <div className="glass-card p-5 xs:p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2.5 sm:p-3 rounded-xl bg-accent-3/10 text-accent-3 border border-accent-3/20 shrink-0">
              ...
              <div className="space-y-2.5 sm:space-y-3">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-2.5 text-xs sm:text-sm text-text-secondary">
