  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ─ CHIBI CHARACTER ───────────────────────────────── */}
        <g className="chibi-group">
          {/* Drop shadow */}
          <ellipse cx="390" cy="428" rx="60" ry="11" fill="rgba(0,0,0,0.38)" />

          {/* Legs */}
          <rect x="354" y="398" width="30" height="36" rx="9" fill="#1a3060" />
          <rect x="392" y="398" width="30" height="36" rx="9" fill="#1a3060" />
          {/* Sneakers */}
          <rect x="348" y="428" width="38" height="13" rx="6" fill="#F2EDE4" />
          <rect x="386" y="428" width="38" height="13" rx="6" fill="#F2EDE4" />
          <rect x="348" y="428" width="38" height="6" rx="4" fill="#BDB5A4" />
          <rect x="386" y="428" width="38" height="6" rx="4" fill="#BDB5A4" />
          {/* Laces */}
          <line x1="354" y1="433" x2="380" y2="433" stroke="#C8A96E" strokeWidth="1.6" />
          <line x1="392" y1="433" x2="418" y2="433" stroke="#C8A96E" strokeWidth="1.6" />

          {/* Torso / Hoodie */}
          <rect x="332" y="306" width="116" height="98" rx="24" fill="url(#hoodiGd)" />
          {/* Hoodie center zip */}
          <line x1="390" y1="316" x2="390" y2="380" stroke="rgba(200,169,110,0.35)" strokeWidth="1.6" strokeDasharray="4 3" />
          {/* Pocket */}
          <path d="M354 376 Q390 384 426 376 L426 393 Q390 400 354 393 Z" fill="url(#pocketGd)" />
          {/* Code logo on hoodie */}
          <text x="372" y="352" fill="rgba(200,169,110,0.75)" fontSize="14" fontFamily="monospace" fontWeight="bold">{'</>'}</text>
          {/* Hood arch */}
          <path d="M340 318 Q318 285 350 272 Q390 264 430 272 Q462 285 440 318 Z" fill="#1a3060" />
          <path d="M348 318 Q328 290 358 278 Q390 272 422 278 Q452 290 432 318 Z" fill="#1e408a" />

          {/* Left arm */}
          <path d="M338 336 Q296 356 278 378" stroke="#1a3060" strokeWidth="28" strokeLinecap="round" fill="none" />
          <path d="M338 336 Q296 356 278 378" stroke="#163070" strokeWidth="23" strokeLinecap="round" fill="none" />
          {/* Left hand */}
          <ellipse cx="273" cy="383" rx="15" ry="11" fill="url(#skinGd)" />
          <rect x="260" y="374" width="7" height="11" rx="3.5" fill="url(#skinGd)" transform="rotate(-15 263 380)" />
          <rect x="267" y="371" width="7" height="13" rx="3.5" fill="url(#skinGd)" transform="rotate(-5 270 377)" />
          <rect x="276" y="371" width="7" height="13" rx="3.5" fill="url(#skinGd)" transform="rotate(5 279 377)" />
          <rect x="284" y="373" width="7" height="11" rx="3.5" fill="url(#skinGd)" transform="rotate(15 287 379)" />

          {/* Right arm */}
          <path d="M442 336 Q484 356 502 378" stroke="#1a3060" strokeWidth="28" strokeLinecap="round" fill="none" />
          <path d="M442 336 Q484 356 502 378" stroke="#163070" strokeWidth="23" strokeLinecap="round" fill="none" />
          {/* Right hand */}
          <ellipse cx="507" cy="383" rx="15" ry="11" fill="url(#skinGd)" />
          <rect x="495" y="374" width="7" height="11" rx="3.5" fill="url(#skinGd)" transform="rotate(-15 498 380)" />
          <rect x="502" y="371" width="7" height="13" rx="3.5" fill="url(#skinGd)" transform="rotate(-5 505 377)" />
          <rect x="511" y="371" width="7" height="13" rx="3.5" fill="url(#skinGd)" transform="rotate(5 514 377)" />
          <rect x="519" y="373" width="7" height="11" rx="3.5" fill="url(#skinGd)" transform="rotate(15 522 379)" />

          {/* Neck */}
          <rect x="374" y="274" width="32" height="24" rx="7" fill="url(#skinGd)" />

          {/* ── HEAD ─────────────────────────────────────── */}
          <ellipse cx="390" cy="244" rx="64" ry="68" fill="url(#skinGd)" />
          <ellipse cx="390" cy="254" rx="55" ry="55" fill="#FDDBB4" opacity="0.45" />

          {/* ── HAIR ─────────────────────────────────────── */}
          <ellipse cx="390" cy="225" rx="68" ry="60" fill="url(#hairGd)" />
          {/* Spiky front pieces */}
          <path d="M326 204 Q317 170 332 154 Q340 180 346 196 Z" fill="url(#hairGd)" />
          <path d="M342 193 Q332 157 350 140 Q356 168 360 184 Z" fill="#200848" />
          <path d="M360 184 Q354 148 372 132 Q376 160 374 178 Z" fill="url(#hairGd)" />
          <path d="M390 179 Q390 142 406 126 Q408 156 406 174 Z" fill="#200848" />
          <path d="M414 182 Q418 146 436 132 Q436 160 432 178 Z" fill="url(#hairGd)" />
          <path d="M432 190 Q442 155 458 145 Q454 170 448 186 Z" fill="#200848" />
          <path d="M448 198 Q462 165 476 157 Q468 182 461 196 Z" fill="url(#hairGd)" />
          {/* Hair shine streaks */}
          <path d="M344 192 Q358 172 376 168" stroke="#4a20a0" strokeWidth="2.5" fill="none" strokeLinecap="round" opacity="0.55" />
          <path d="M370 178 Q384 160 400 158" stroke="#4a20a0" strokeWidth="2" fill="none" strokeLinecap="round" opacity="0.55" />

          {/* Ears */}
          <ellipse cx="326" cy="244" rx="11" ry="15" fill="url(#skinGd)" />
          <ellipse cx="454" cy="244" rx="11" ry="15" fill="url(#skinGd)" />
          <ellipse cx="326" cy="244" rx="7" ry="10" fill="#F5C890" />
          <ellipse cx="454" cy="244" rx="7" ry="10" fill="#F5C890" />

          {/* ── GLASSES ──────────────────────────────────── */}
          <rect x="342" y="232" width="38" height="28" rx="9" stroke="#C8A96E" strokeWidth="2.5" fill="rgba(126,207,255,0.10)" />
          <rect x="398" y="232" width="38" height="28" rx="9" stroke="#C8A96E" strokeWidth="2.5" fill="rgba(126,207,255,0.10)" />
          <line x1="380" y1="244" x2="398" y2="244" stroke="#C8A96E" strokeWidth="2" />
          <line x1="342" y1="244" x2="326" y2="246" stroke="#C8A96E" strokeWidth="2" />
          <line x1="436" y1="244" x2="454" y2="246" stroke="#C8A96E" strokeWidth="2" />
          {/* Lens glint */}
          <rect className="glasses-glint" x="346" y="235" width="10" height="4" rx="2" fill="rgba(255,255,255,0.72)" opacity="0" />

          {/* Eyes behind glasses */}
          <ellipse cx="361" cy="247" rx="11" ry="11" fill="#07041a" />
          <ellipse cx="417" cy="247" rx="11" ry="11" fill="#07041a" />
          <circle cx="361" cy="247" r="7" fill="#1a2888" />
          <circle cx="417" cy="247" r="7" fill="#1a2888" />
          <circle cx="361" cy="247" r="3.5" fill="#040212" />
          <circle cx="417" cy="247" r="3.5" fill="#040212" />
          {/* Eye shine */}
          <circle cx="364" cy="243" r="2.5" fill="white" opacity="0.88" />
          <circle cx="420" cy="243" r="2.5" fill="white" opacity="0.88" />
          <circle cx="358" cy="250" r="1.2" fill="white" opacity="0.38" />
          <circle cx="414" cy="250" r="1.2" fill="white" opacity="0.38" />

          {/* Nose */}
          <ellipse cx="390" cy="264" rx="4.5" ry="3.5" fill="#F0BE88" opacity="0.65" />

          {/* Smile */}
          <path d="M374 278 Q390 290 406 278" stroke="#E8956A" strokeWidth="2.8" fill="none" strokeLinecap="round" />

          {/* Blush */}
          <ellipse cx="336" cy="267" rx="16" ry="9" fill="#FF8888" opacity="0.20" />
          <ellipse cx="444" cy="267" rx="16" ry="9" fill="#FF8888" opacity="0.20" />

          {/* ── HEADPHONE ────────────────────────────────── */}
          <path d="M330 214 Q330 172 390 170 Q450 172 450 214" stroke="#C8A96E" strokeWidth="7" fill="none" strokeLinecap="round" />
          <rect x="322" y="212" width="20" height="30" rx="7" fill="#C8A96E" />
          <rect x="438" y="212" width="20" height="30" rx="7" fill="#C8A96E" />
          <rect x="325" y="216" width="14" height="22" rx="5" fill="#8a6a30" />
          <rect x="441" y="216" width="14" height="22" rx="5" fill="#8a6a30" />
          {/* Headphone LEDs */}
          <circle cx="332" cy="224" r="2.5" fill="#7ECFFF" filter="url(#neonF)" />
          <circle cx="448" cy="224" r="2.5" fill="#7ECFFF" filter="url(#neonF)" />

          {/* ── HOODIE DETAILS ───────────────────────────── */}
          {/* Hoodie drawstring */}
          <path d="M378 318 L368 330 L362 344" stroke="rgba(200,169,110,0.3)" strokeWidth="1.2" fill="none" strokeLinecap="round" />
          <path d="M402 318 L412 330 L418 344" stroke="rgba(200,169,110,0.3)" strokeWidth="1.2" fill="none" strokeLinecap="round" />
        </g>
